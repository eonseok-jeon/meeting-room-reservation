...
interface ReservationActionMessageBannerProps {
  message: ReservationActionMessage;
}

export function ReservationActionMessageBanner({ message }: ReservationActionMessageBannerProps) {
  return (
    <div
      css={css`
        padding: 0 24px;
